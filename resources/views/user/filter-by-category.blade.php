...
<section class="section-sm">
  ...
  <div class="post-slider">
      <img src="{{ asset('images/post/'.$post->thumbnail) }}" class="card-img-top" alt="post-thumb">
  </div>
  <div class="card-body">
      ...
      {{-- <li class="list-inline-item">
          ...
          <img src="{{ asset('assets/frontend') }}/images/john-doe.jpg">
      ...
      <li class="list-inline-item">
          ...
          <li class="list-inline-item"><a href="tags.html">Category <b class="text-primary text-bold">{{ $post->category_name }}</b></a></li>
          </ul>
      </li>
      </ul>
  ...
  <div class="widget widget-about">
    ...
    <img class="img-fluid" src="{{ asset('assets/frontend') }}/images/author.jpg" alt="Themefisher">
  ...
  <!-- Promotion -->
  <div class="promotion">
    <img src="{{ asset('assets/frontend') }}/images/promotion.jpg" class="img-fluid w-100">
  ...
  <div class="widget widget-author">
    ...
    <div class="media align-items-center">
      <div class="mr-3">
        <img class="widget-author-image" src="{{ asset('assets/frontend') }}/images/john-doe.jpg">
      </div>
    ...
    <div class="media align-items-center">
      <div class="mr-3">
        <img class="widget-author-image" src="{{ asset('assets/frontend') }}/images/kate-stone.jpg">
      </div>
      <div class="media-body">
    ...
    <div class="media align-items-center">
      <div class="mr-3">
        <img class="widget-author-image" src="{{ asset('assets/frontend') }}/images/john-doe.jpg" alt="John Doe">
      </div>
      <div class="media-body">
  ...
  <div class="widget">
    ...
    <article class="widget-card">
      <div class="d-flex">
        <img class="card-img-sm" src="{{ asset('assets/frontend') }}/images/post/post-10.jpg">
        <div class="ml-3">
    ...
    <article class="widget-card">
      <div class="d-flex">
        <img class="card-img-sm" src="{{ asset('assets/frontend') }}/images/post/post-3.jpg">
        <div class="ml-3">
    ...
    <article class="widget-card">
      <div class="d-flex">
        <img class="card-img-sm" src="{{ asset('assets/frontend') }}/images/post/post-7.jpg">
        <div class="ml-3">
          <h5><a class="post-title" href="post-details.html">Advice From a Twenty Something</a></h5>
          <ul class="card-meta list-inline mb-0">
            <li class="list-inline-item mb-0">
  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-4 mb-5">
        ...
        <article class="card">
          <div class="post-slider slider-sm">
            <img src="{{ asset('assets/frontend') }}/images/post/post-1.jpg" class="card-img-top" alt="post-thumb">
          </div>
      ...
      <div class="col-lg-4 mb-5">
        ...
        <article class="card mb-4">
          <div class="card-body d-flex">
            <img class="card-img-sm" src="{{ asset('assets/frontend') }}/images/post/post-2.jpg">
            <div class="ml-3">
        ...
        <article class="card mb-4">
          <div class="card-body d-flex">
            <img class="card-img-sm" src="{{ asset('assets/frontend') }}/images/post/post-4.jpg">
            <div class="ml-3">
      ...
      <div class="col-lg-4 mb-5">
        ...
        <article class="card">
          <div class="post-slider slider-sm">
            <img src="{{ asset('assets/frontend') }}/images/post/post-5.jpg" class="card-img-top" alt="post-thumb">
          </div>
          <div class="card-body">
            ...
            <ul class="card-meta list-inline">
              <li class="list-inline-item">
                <a href="author-single.html" class="card-meta-author">
                  <img src="{{ asset('assets/frontend') }}/images/kate-stone.jpg" alt="Kate Stone">
